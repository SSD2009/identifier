...
classifier=ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/-sqmGQKOh/model.json',modelLoaded);
...
function gotResult(error,result){
    if(error){
        ...
        console.log(result);
        document.getElementById("image").innerHTML=result[0].label;
